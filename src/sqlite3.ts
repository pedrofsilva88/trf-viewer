...
export const useSqliteInitEffect = (setSqlite3: React.Dispatch<React.SetStateAction<Sqlite3 | undefined>>) => useEffect(() => {

    sqlite3InitModule().then((sqlite3) => {
        console.log("Loaded sqlite3", (sqlite3 as any).version)
        setSqlite3(sqlite3)
